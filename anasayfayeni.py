...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.takmbelirle_button.setGeometry(QtCore.QRect(150, 180, 91, 31))
        self.takmbelirle_button.setObjectName("takmbelirle_button")
        self.single = QtWidgets.QRadioButton(self.anasayfa)
        self.single.setGeometry(QtCore.QRect(35, 150, 82, 17))
        self.single.setObjectName("single")
        self.team = QtWidgets.QRadioButton(self.anasayfa)
        self.team.setGeometry(QtCore.QRect(165, 150, 61, 17))
        self.team.setObjectName("team")
        self.team.setChecked(True)
        self.membercount_spinbox = QtWidgets.QSpinBox(self.anasayfa)
        self.membercount_spinbox.setGeometry(QtCore.QRect(325, 150, 51, 21))
        self.membercount_spinbox.setObjectName("membercount_spinbox")
        self.label_2 = QtWidgets.QLabel(self.anasayfa)
        self.label_2.setGeometry(QtCore.QRect(245, 150, 81, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.single.setText(_translate("Ana Sayfa", "Tek Kişi"))
        self.team.setText(_translate("Ana Sayfa", "Takımlı"))
        self.label_2.setText(_translate("Ana Sayfa", "Kişi Sayısını Gir"))
...
#Burada Takımları Belirle Butonuna Bastığımızda Açılacak Yeni Formu Ve Takım Sayısının Hangi Kurallara Göre Belirleneceğini Belirtiyoruz
    def yeniformac(self):
        ...
        if isTeam is True and int(self.membercount_spinbox.text()) < 2:
            msg.setText('Takımlı Seçeneğini Kullanmak İçin En Az 2 Değer Girilmelidir!!')
            msg.exec_()
            return
                
        if isTeam is False and int(self.membercount_spinbox.text()) != 1:
            msg.setText('Tek Kişi Seçeneğini Kullanırken Takım İçi Kişi Sayısı 1\'den Farklı Olamaz!!')
            self.membercount_spinbox.setValue(1)
            msg.exec_()
            return
        ...
        self.ui = Ui_Form()
        self.ui.setupUi(self.window,takimsayisi, int(self.membercount_spinbox.text()), isTeam)
        self.window.show()
        MainWindow.hide()
